...
import com.camile.common.db.DataSourceEnum;
import com.camile.common.db.DynamicDataSource;
import com.camile.common.util.SpringContextUtil;
...
public abstract class ServiceImpl<Mapper, Record, Example> implements Service<Record, Example> {
